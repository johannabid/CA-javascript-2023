...
1. You will need to make two calls to this API:
...
Husk å sett titelen på HTML-siden til en av property-verdiene, som navn, tittel eller en annen relevant property
